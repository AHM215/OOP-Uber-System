...
public:
    Payment() {}
    Payment(int id, int passenger_id, float amount) : id(id), passenger_id(passenger_id), amount(amount) {}
};
...
public:
    Credit() {}
    Credit(int id, int passenger_id, float amount, int numCard, int CVVcode, string dateCard) : Payment(id, passenger_id, amount), numCard(numCard), CVVcode(CVVcode), dateCard(dateCard) {}
};
...
public:
    Paypal() {}
    Paypal(int id, int passenger_id, float amount, string email) : Payment(id, passenger_id, amount), email(email) {}
};
